...
class Course(models.Model):
    ...
    teacher_tell = models.CharField(max_length=300, default=u"将来的你定会感谢现在的自己，加油同学！", verbose_name=u"老师告诉你")
...
class Video(models.Model):
    ...
    url = models.CharField(max_length=1000, default="https://space.bilibili.com/1565906988", verbose_name=u"访问地址")
